...
<head>
    ...
    <title><?php echo e(config('app.name', 'SMP Negeri 01 Namrole')); ?> - <?php echo $__env->yieldContent('title', 'Admin Dashboard'); ?></title>
...
<body class="font-sans antialiased bg-gray-100">
        ...
        <div id="sidebar" class="fixed lg:sticky lg:top-0 inset-y-0 left-0 z-50 w-64 bg-primary-600 text-white flex flex-col transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out lg:h-screen overflow-y-auto">
            ...
            <div class="p-6 border-b border-primary-500">
                <div class="flex items-center">
                    <img src="<?php echo e(asset('logo.png')); ?>" alt="Logo" class="h-8 w-auto mr-3">
                    <div>
            ...
            <nav class="flex-1 px-4 py-6 space-y-2">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center px-4 py-2 rounded-lg hover:bg-primary-500 transition-colors <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-primary-500' : ''); ?>">
                ...
                <a href="<?php echo e(route('admin.messages.index')); ?>" class="flex items-center px-4 py-2 rounded-lg hover:bg-primary-500 transition-colors <?php echo e(request()->routeIs('admin.messages.*') ? 'bg-primary-500' : ''); ?>">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <?php if($unreadCount > 0): ?>
                        <span class="ml-auto bg-red-500 text-white text-xs px-2 py-1 rounded-full"><?php echo e($unreadCount); ?></span>
                    <?php endif; ?>
                </a>

                <a href="<?php echo e(route('admin.home-sections.index')); ?>" class="flex items-center px-4 py-2 rounded-lg hover:bg-primary-500 transition-colors <?php echo e(request()->routeIs('admin.home-sections.*') ? 'bg-primary-500' : ''); ?>">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2H5a2 2 0 00-2-2z"></path>
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 5a2 2 0 012-2h4a2 2 0 012 2v2H8V5z"></path>
                    </svg>
                ...
                <a href="<?php echo e(route('admin.school-profile.index')); ?>" class="flex items-center px-4 py-2 rounded-lg hover:bg-primary-500 transition-colors <?php echo e(request()->routeIs('admin.school-profile.*') ? 'bg-primary-500' : ''); ?>">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('admin.contact.index')); ?>" class="flex items-center px-4 py-2 rounded-lg hover:bg-primary-500 transition-colors <?php echo e(request()->routeIs('admin.contact.*') ? 'bg-primary-500' : ''); ?>">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('admin.social-media.index')); ?>" class="flex items-center px-4 py-2 rounded-lg hover:bg-primary-500 transition-colors <?php echo e(request()->routeIs('admin.social-media.*') ? 'bg-primary-500' : ''); ?>">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('admin.user-management.index')); ?>" class="flex items-center px-4 py-2 rounded-lg hover:bg-primary-500 transition-colors <?php echo e(request()->routeIs('admin.user-management.*') ? 'bg-primary-500' : ''); ?>">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="space-y-1">
                    <button onclick="toggleContentDropdown()" class="w-full flex items-center justify-between px-4 py-2 rounded-lg hover:bg-primary-500 transition-colors <?php echo e(request()->routeIs('admin.news.*', 'admin.academic-calendar.*', 'admin.gallery.*', 'admin.documents.*', 'admin.teachers.*', 'admin.achievements.*', 'admin.subjects.*', 'admin.libraries.*', 'admin.vision-missions.*') ? 'bg-primary-500' : ''); ?>">
                        <div class="flex items-center">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div id="content-dropdown" class="hidden ml-4 space-y-1">
                        <a href="<?php echo e(route('admin.news.index')); ?>" class="flex items-center px-4 py-2 rounded-lg hover:bg-primary-500 transition-colors <?php echo e(request()->routeIs('admin.news.*') ? 'bg-primary-500' : ''); ?>">
                        ...
                        <a href="<?php echo e(route('admin.academic-calendar.index')); ?>" class="flex items-center px-4 py-2 rounded-lg hover:bg-primary-500 transition-colors <?php echo e(request()->routeIs('admin.academic-calendar.*') ? 'bg-primary-500' : ''); ?>">
                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="<?php echo e(route('admin.gallery.index')); ?>" class="flex items-center px-4 py-2 rounded-lg hover:bg-primary-500 transition-colors <?php echo e(request()->routeIs('admin.gallery.*') ? 'bg-primary-500' : ''); ?>">
                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="<?php echo e(route('admin.documents.index')); ?>" class="flex items-center px-4 py-2 rounded-lg hover:bg-primary-500 transition-colors <?php echo e(request()->routeIs('admin.documents.*') ? 'bg-primary-500' : ''); ?>">
                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="<?php echo e(route('admin.headmaster-greetings.index')); ?>" class="flex items-center px-4 py-2 rounded-lg hover:bg-primary-500 transition-colors <?php echo e(request()->routeIs('admin.headmaster-greetings.*') ? 'bg-primary-500' : ''); ?>">
                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="<?php echo e(route('admin.teachers.index')); ?>" class="flex items-center px-4 py-2 rounded-lg hover:bg-primary-500 transition-colors <?php echo e(request()->routeIs('admin.teachers.*') ? 'bg-primary-500' : ''); ?>">
                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z"></path>
                            </svg>
                        ...
                        <a href="<?php echo e(route('admin.achievements.index')); ?>" class="flex items-center px-4 py-2 rounded-lg hover:bg-primary-500 transition-colors <?php echo e(request()->routeIs('admin.achievements.*') ? 'bg-primary-500' : ''); ?>">
                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="<?php echo e(route('admin.accreditations.index')); ?>" class="flex items-center px-4 py-2 rounded-lg hover:bg-primary-500 transition-colors <?php echo e(request()->routeIs('admin.accreditations.*') ? 'bg-primary-500' : ''); ?>">
                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="<?php echo e(route('admin.facilities.index')); ?>" class="flex items-center px-4 py-2 rounded-lg hover:bg-primary-500 transition-colors <?php echo e(request()->routeIs('admin.facilities.*') ? 'bg-primary-500' : ''); ?>">
                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                            </svg>
                        ...
                        <a href="<?php echo e(route('admin.subjects.index')); ?>" class="flex items-center px-4 py-2 rounded-lg hover:bg-primary-500 transition-colors <?php echo e(request()->routeIs('admin.subjects.*') ? 'bg-primary-500' : ''); ?>">
                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="<?php echo e(route('admin.libraries.index')); ?>" class="flex items-center px-4 py-2 rounded-lg hover:bg-primary-500 transition-colors <?php echo e(request()->routeIs('admin.libraries.*') ? 'bg-primary-500' : ''); ?>">
                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
                            </svg>
                ...
                <!-- PPDB Dropdown Menu -->
                <div class="space-y-1">
                    <button onclick="togglePPDBDropdown()" class="w-full flex items-center justify-between px-4 py-2 rounded-lg hover:bg-primary-500 transition-colors <?php echo e(request()->routeIs('admin.ppdb.*') || request()->routeIs('admin.ppdb-registrations.*') || request()->routeIs('admin.ppdb-export.*') ? 'bg-primary-500' : ''); ?>">
                        <div class="flex items-center">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z"></path>
                            </svg>
                    ...
                    <div id="ppdb-dropdown" class="hidden ml-4 space-y-1">
                        <a href="<?php echo e(route('admin.ppdb.index')); ?>" class="flex items-center px-4 py-2 rounded-lg hover:bg-primary-500 transition-colors <?php echo e(request()->routeIs('admin.ppdb.index') || request()->routeIs('admin.ppdb.create') || request()->routeIs('admin.ppdb.edit') || request()->routeIs('admin.ppdb.show') ? 'bg-primary-500' : ''); ?>">
                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="<?php echo e(route('admin.ppdb.registrations')); ?>" class="flex items-center px-4 py-2 rounded-lg hover:bg-primary-500 transition-colors <?php echo e(request()->routeIs('admin.ppdb.registrations') || request()->routeIs('admin.ppdb.show-registration') ? 'bg-primary-500' : ''); ?>">
                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z"></path>
                            </svg>
                        ...
                        <a href="<?php echo e(route('admin.ppdb.export')); ?>" class="flex items-center px-4 py-2 rounded-lg hover:bg-primary-500 transition-colors <?php echo e(request()->routeIs('admin.ppdb.export') ? 'bg-primary-500' : ''); ?>">
                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                            </svg>
                ...
                <div class="border-t border-primary-500 pt-4 mt-4">
                    <a href="<?php echo e(route('home')); ?>" class="flex items-center px-4 py-2 rounded-lg hover:bg-primary-500 transition-colors">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="px-6 py-4">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-4">
                            <span class="text-sm text-gray-500 hidden sm:block"><?php echo e(now()->format('d M Y, H:i')); ?></span>
                            ...
                            <div class="relative">
                                <button onclick="toggleProfileDropdown()" class="flex items-center space-x-3 px-3 py-2 rounded-lg hover:bg-gray-100 transition-colors">
                                    <div class="w-8 h-8 rounded-full overflow-hidden border border-gray-200 bg-primary-500 flex items-center justify-center">
                                        <img src="<?php echo e(auth()->user()->photo_url); ?>" alt="<?php echo e(auth()->user()->name); ?>" class="w-8 h-8 object-cover" onerror="this.style.display='none'; this.nextElementSibling.classList.remove('hidden');">
                                        <span class="text-white font-semibold text-sm hidden"><?php echo e(substr(auth()->user()->name, 0, 1)); ?></span>
                                    </div>
                                ...
                                <div id="profile-dropdown" class="hidden absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">
                                    <div class="px-4 py-3 border-b border-gray-100">
                                        <div class="flex items-center space-x-3">
                                            <div class="w-10 h-10 rounded-full overflow-hidden border border-gray-200 bg-primary-500 flex items-center justify-center">
                                                <img src="<?php echo e(auth()->user()->photo_url); ?>" alt="<?php echo e(auth()->user()->name); ?>" class="w-10 h-10 object-cover" onerror="this.style.display='none'; this.nextElementSibling.classList.remove('hidden');">
                                                <span class="text-white font-semibold text-sm hidden"><?php echo e(substr(auth()->user()->name, 0, 1)); ?></span>
                                            </div>
                                            <div class="flex-1">
                                                <p class="text-sm font-medium text-gray-900"><?php echo e(auth()->user()->name); ?></p>
                                    ...
                                    <a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                        <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                                        </svg>
                                        Profile Settings
                                    </a>
                                    <a href="<?php echo e(route('home')); ?>" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                        <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const isContentPage = <?php echo e(request()->routeIs('admin.news.*', 'admin.academic-calendar.*', 'admin.gallery.*', 'admin.documents.*', 'admin.teachers.*', 'admin.achievements.*', 'admin.subjects.*') ? 'true' : 'false'); ?>;
            const isPPDBPage = <?php echo e(request()->routeIs('admin.ppdb.*') || request()->routeIs('admin.ppdb-registrations.*') || request()->routeIs('admin.ppdb-export.*') ? 'true' : 'false'); ?>;
        ...
        function markNotificationAsRead(notificationId) {
            fetch(`<?php echo e(url('admin/notifications')); ?>/${notificationId}/mark-as-read`, {
                method: 'POST',
                headers: {
        ...
        function markAllAsRead() {
            fetch('<?php echo e(route("admin.notifications.mark-all-as-read")); ?>', {
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                    'Content-Type': 'application/json'
...
<?php /**PATH D:\laragon\www\website-sekolah-namrole21\resources\views/layouts/admin.blade.php ENDPATH**/ ?>