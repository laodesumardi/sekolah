...
<div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="mt-4 sm:mt-0">
                <div class="text-right">
                    ...
                    <p class="font-semibold"><?php echo e(now()->format('d M Y, H:i')); ?></p>
                </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-4 lg:p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900"><?php echo e($totalUsers); ?></p>
                    <p class="text-xs text-gray-500"><?php echo e($teachersCount); ?> Guru, <?php echo e($studentsCount); ?> Siswa</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-4 lg:p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900"><?php echo e($ppdbRegistrationsCount); ?></p>
                    <p class="text-xs text-gray-500"><?php echo e($ppdbPendingCount); ?> Pending</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-4 lg:p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900"><?php echo e($messagesCount); ?></p>
                    <p class="text-xs text-gray-500"><?php echo e($unreadMessagesCount); ?> Belum dibaca</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-4 lg:p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900"><?php echo e($notificationsCount); ?></p>
                    <p class="text-xs text-gray-500"><?php echo e($unreadNotificationsCount); ?> Belum dibaca</p>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="flex items-end justify-between h-48 space-x-3">
                            ...
                            <div class="flex flex-col items-center flex-1 group">
                                <div class="w-full flex flex-col justify-end h-40 mb-3 relative">
                                    <div class="bg-blue-600 rounded-t transition-all duration-300 group-hover:bg-blue-700" 
                                         style="height: <?php echo e($newsCount > 0 ? ($activeNews / $newsCount) * 100 : 0); ?>%"></div>
                                    <div class="bg-blue-300 rounded-b transition-all duration-300 group-hover:bg-blue-400" 
                                         style="height: <?php echo e($newsCount > 0 ? (($newsCount - $activeNews) / $newsCount) * 100 : 0); ?>%"></div>
                                    <!-- Tooltip -->
                                    <div class="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap">
                                        Aktif: <?php echo e($activeNews); ?> | Total: <?php echo e($newsCount); ?>

                                    </div>
                                </div>
                                <div class="text-center">
                                    <div class="text-sm font-medium text-gray-800">Berita</div>
                                    <div class="text-lg font-bold text-blue-600"><?php echo e($newsCount); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col items-center flex-1 group">
                                <div class="w-full flex flex-col justify-end h-40 mb-3 relative">
                                    ...
                                    <div class="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap">
                                        Total: <?php echo e($achievementsCount); ?>

                                    </div>
                                </div>
                                <div class="text-center">
                                    <div class="text-sm font-medium text-gray-800">Prestasi</div>
                                    <div class="text-lg font-bold text-blue-600"><?php echo e($achievementsCount); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col items-center flex-1 group">
                                <div class="w-full flex flex-col justify-end h-40 mb-3 relative">
                                    <div class="bg-blue-600 rounded-t transition-all duration-300 group-hover:bg-blue-700" 
                                         style="height: <?php echo e($facilitiesCount > 0 ? ($activeFacilities / $facilitiesCount) * 100 : 0); ?>%"></div>
                                    <div class="bg-blue-300 rounded-b transition-all duration-300 group-hover:bg-blue-400" 
                                         style="height: <?php echo e($facilitiesCount > 0 ? (($facilitiesCount - $activeFacilities) / $facilitiesCount) * 100 : 0); ?>%"></div>
                                    <div class="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap">
                                        Aktif: <?php echo e($activeFacilities); ?> | Total: <?php echo e($facilitiesCount); ?>

                                    </div>
                                </div>
                                <div class="text-center">
                                    <div class="text-sm font-medium text-gray-800">Fasilitas</div>
                                    <div class="text-lg font-bold text-blue-600"><?php echo e($facilitiesCount); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col items-center flex-1 group">
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="text-lg font-bold text-blue-600"><?php echo e($galleryCount); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col items-center flex-1 group">
                                <div class="w-full flex flex-col justify-end h-40 mb-3 relative">
                                    <div class="bg-blue-600 rounded-t transition-all duration-300 group-hover:bg-blue-700" style="height: 100%"></div>
                                    <div class="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap">
                                        Total: <?php echo e($staffCount); ?>

                                    </div>
                                </div>
                                <div class="text-center">
                                    <div class="text-sm font-medium text-gray-800">Staff</div>
                                    <div class="text-lg font-bold text-blue-600"><?php echo e($staffCount); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col items-center flex-1 group">
                                <div class="w-full flex flex-col justify-end h-40 mb-3 relative">
                                    <div class="bg-blue-600 rounded-t transition-all duration-300 group-hover:bg-blue-700" style="height: 100%"></div>
                                    <div class="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap">
                                        Total: <?php echo e($documentsCount); ?>

                                    </div>
                                </div>
                                <div class="text-center">
                                    <div class="text-sm font-medium text-gray-800">Dokumen</div>
                                    <div class="text-lg font-bold text-blue-600"><?php echo e($documentsCount); ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div class="bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg p-4 text-center border border-blue-200">
                            <div class="text-2xl font-bold text-blue-700 mb-1">
                                <?php echo e($newsCount + $achievementsCount + $facilitiesCount + $galleryCount + $staffCount + $documentsCount); ?>
                        ...
                        <div class="bg-gradient-to-r from-green-50 to-green-100 rounded-lg p-4 text-center border border-green-200">
                            <div class="text-2xl font-bold text-green-700 mb-1"><?php echo e($activeNews + $activeFacilities); ?></div>
                        ...
                        <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg p-4 text-center border border-gray-200">
                            <div class="text-2xl font-bold text-gray-700 mb-1">
                                <?php echo e($newsCount + $achievementsCount + $facilitiesCount + $galleryCount + $staffCount + $documentsCount - ($activeNews + $activeFacilities)); ?>
            ...
            <div class="p-6">
                <div class="grid grid-cols-2 gap-4">
                    <div class="text-center p-4 bg-blue-50 rounded-lg">
                        <div class="text-2xl font-bold text-blue-600"><?php echo e($subjectsCount); ?></div>
                        <div class="text-sm text-gray-600">Mata Pelajaran</div>
                    </div>
                    <div class="text-center p-4 bg-green-50 rounded-lg">
                        <div class="text-2xl font-bold text-green-600"><?php echo e($assignmentsCount); ?></div>
                        <div class="text-sm text-gray-600">Tugas</div>
                    </div>
                    <div class="text-center p-4 bg-purple-50 rounded-lg">
                        <div class="text-2xl font-bold text-purple-600"><?php echo e($lessonsCount); ?></div>
                        <div class="text-sm text-gray-600">Materi</div>
                    </div>
                    <div class="text-center p-4 bg-yellow-50 rounded-lg">
                        <div class="text-2xl font-bold text-yellow-600"><?php echo e($coursesCount); ?></div>
                        <div class="text-sm text-gray-600">Kursus</div>
                    </div>
                    <div class="text-center p-4 bg-indigo-50 rounded-lg">
                        <div class="text-2xl font-bold text-indigo-600"><?php echo e($forumsCount); ?></div>
                        <div class="text-sm text-gray-600">Forum</div>
                    </div>
                    <div class="text-center p-4 bg-pink-50 rounded-lg">
                        <div class="text-2xl font-bold text-pink-600"><?php echo e($librariesCount); ?></div>
    ...
    <div class="bg-white rounded-lg shadow">
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div class="text-center p-4 bg-yellow-50 rounded-lg">
                    <div class="text-2xl font-bold text-yellow-600"><?php echo e($ppdbPendingCount); ?></div>
                    <div class="text-sm text-gray-600">Pending</div>
                </div>
                <div class="text-center p-4 bg-green-50 rounded-lg">
                    <div class="text-2xl font-bold text-green-600"><?php echo e($ppdbApprovedCount); ?></div>
                    <div class="text-sm text-gray-600">Disetujui</div>
                </div>
                <div class="text-center p-4 bg-red-50 rounded-lg">
                    <div class="text-2xl font-bold text-red-600"><?php echo e($ppdbRejectedCount); ?></div>
    ...
    <div class="bg-white rounded-lg shadow">
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                <a href="<?php echo e(route('admin.school-profile.index')); ?>" class="flex flex-col items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-center">
                ...
                <a href="<?php echo e(route('admin.news.index')); ?>" class="flex flex-col items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-center">
                ...
                <a href="<?php echo e(route('admin.achievements.index')); ?>" class="flex flex-col items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-center">
                ...
                <a href="<?php echo e(route('admin.facilities.index')); ?>" class="flex flex-col items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-center">
                ...
                <a href="<?php echo e(route('admin.ppdb.index')); ?>" class="flex flex-col items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-center">
                ...
                <a href="<?php echo e(route('admin.messages.index')); ?>" class="flex flex-col items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-center">
                ...
                <a href="<?php echo e(route('admin.gallery.index')); ?>" class="flex flex-col items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-center">
                ...
                <a href="<?php echo e(route('home')); ?>" class="flex flex-col items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-center">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-xs text-gray-500"><?php echo e(ucfirst($user->role)); ?> • <?php echo e($user->created_at->format('d M Y')); ?></p>
                        </div>
                    </div>
            ...
            <div class="p-6">
                <div class="space-y-3">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="flex-1">
                            <p class="text-sm font-medium text-gray-900"><?php echo e(Str::limit($news->title, 30)); ?></p>
                            <p class="text-xs text-gray-500"><?php echo e($news->created_at->format('d M Y')); ?></p>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\website-sekolah-namrole21\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>