...
Route::middleware(['auth'])->group(function () {
    // Student PPDB Status (accessible without PPDB approval)
    Route::prefix('student')->name('student.')->middleware(['auth', 'role:student'])->group(function () {
        Route::get('/ppdb-status', [App\Http\Controllers\Student\PPDBStatusController::class, 'index'])->name('ppdb-status');
