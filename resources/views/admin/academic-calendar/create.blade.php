...
@section('title', 'Tambah Acara Kalender Akademik')
@section('page-title', 'Tambah Acara Kalender Akademik')
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                ...
                <div class="flex justify-between items-center mb-6">
                    <div>
                        <h2 class="text-2xl font-bold text-primary-900">Tambah Acara Kalender Akademik</h2>
                        <p class="text-gray-600 mt-1">Buat acara baru untuk kalender akademik</p>
                    </div>
                ...
                <form action="{{ route('admin.academic-calendar.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea name="description" id="description" rows="4" 
                                          ...
                                          placeholder="Masukkan deskripsi acara">{{ old('description') }}</textarea>
                                @error('description')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <select name="type" id="type" 
                                    ...
                                    <option value="hari_besar" {{ old('type') == 'hari_besar' ? 'selected' : '' }}>Hari Besar</option>
                    ...
                    <!-- File Upload -->
                    <div class="mt-6" id="file-upload-section" style="display: none;">
